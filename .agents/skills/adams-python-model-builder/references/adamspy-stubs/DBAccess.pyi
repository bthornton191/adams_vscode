...
class PropertyValue:
    ...
    useAprKey: Any
    unsetValue: Any
    def __init__(self, id: int = ..., units=..., offset: int = ..., readonly: bool = ..., writeonly: bool = ..., dbt: bool = ..., default: Any | None = ..., fpreset: Any | None = ...,
                 fpostset: Any | None = ..., doc: Any | None = ..., min: Any | None = ..., gtmin: bool = ..., max: Any | None = ..., ltmax: bool = ..., useAprKey: bool = ...) -> None: ...
...
class ObjectArray(ArrayProperty):
    obj_type: Any
    excluded_type: Any
    def __init__(self, obj_type: Any | None = ..., excluded_type: Any | None = ...,
                 offset: int = ..., num: Any | None = ..., readonly: bool = ..., **kargs) -> None: ...
