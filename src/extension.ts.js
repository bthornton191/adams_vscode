...
function activate(context) {
	...
	const run_selection_command = 'msc_adams.runSelection';
	const runSelectionCommandHandler = async () => {
	...
	vscode.commands.registerCommand(run_selection_command, runSelectionCommandHandler);
