...
|---|---|---|
| `revolution_name` | An Existing Revolution | Specifies the name of an existing revolution. |
...
| `number_of_sides` | Integer | Specifies the number of flat sides Adams View draws on a revolution. |
