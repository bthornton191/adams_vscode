...
The Y_ACC function returns the y-component of the difference between the global acceleration vector of the I_MARKER (i1) and the global acceleration vector of the J_MARKER (i2) as computed in the coordinate system of the R_MARKER (i3)
