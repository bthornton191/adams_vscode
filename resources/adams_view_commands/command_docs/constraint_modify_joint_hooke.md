...
| `new_joint_name` | A new joint | Specifies the name of the new joint. You may use this name later to refer to this joint. Adams View will not allow you to have two joints with the same full name, so you must provide a unique name. |
