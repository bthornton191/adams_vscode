...
Allows the creation of a screw joint. A screw joint is a five-degree-of-freedom joint that constrains the rotational and translational displacement of the I marker as it spins about the z-axis of the J marker.
...
| `in_plane_orientation` | Location | Specifies the orientation of a coordinate system (for example, marker or part) by directing one of the axes and locating one of the |
