...
| `new_point_mass_name` | A New Point_Mass | Specifies the name of the new point_mass. You may use this name later to refer to this point_mass. |
...
| `relative_to` | An Exixting Model, Part Or Marker | Specifies the coordinate system that location coordinates and orientation angles correspond to. |
