...
Allows you to create a stress body, which associates a solid geometry with a rigid body part for stress recovery calculations.

## Parameters

| Parameter | Type | Description |
|---|---|---|
| `rigid_stress_name` | A New Stress Body | Specifies the name of the new stress body. |
