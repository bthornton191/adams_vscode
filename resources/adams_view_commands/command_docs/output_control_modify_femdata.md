...
Allows you to modify data files of component loads, deformations, stresses, or strains for input to subsequent finite element or fatigue life analysis for use in third party products. Adams View will not output to any files unless you specify the format.
