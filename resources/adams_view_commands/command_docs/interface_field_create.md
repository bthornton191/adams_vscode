...
| `spchars_allowed` | Boolean | Default value is "no", the field will accept only alphanumeric characters and underscores. Spaces or other characters are not allowed. |
| `unicode_allowed` | Boolean | Default value is "no", the field will not allow unicode characters. |
