...
| `no_vy` | True_only | Unsets the vy velocity initial condition for the specified part (true) so it no longer has an velocity initial condition. |
...
| `no_wz` | True_only | Unsets the wz velocity initial condition for the specified part (true) so it no longer has an velocity initial condition. |
