...
|---|---|---|
| `contact_name` | Existing Contact | Specifies the name of the contact to be created. |
...
| `j_edge_index` | An Existing edge index | Specifies the edge index of the other edge participating in the contact. This parameter can only exist if the j_edge parameter is specified and used with Adams Solver C++. |
