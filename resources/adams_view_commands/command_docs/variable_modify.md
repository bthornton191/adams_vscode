...
|---|---|---|
| `variable_name` | String | Specifies the name of the variable to modify. |
| `new_variable_name` | String | Specifies the new name to be used for the Adams View variable. You may use this name later to refer to this variable. |
