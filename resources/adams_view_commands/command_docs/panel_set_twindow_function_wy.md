...
The WY function returns the y-component of the difference between the angular velocity vector of the I_MARKER (i1) in ground and the angular velocity vector of the J_MARKER (i2) in ground, as computed in the coordinate system of the R_MARKER (i3)
