...
Allows the creation of a planar joint. A planar joint is a three-degree-of-freedom joint that allows the x-y plane of one part to slide in the x-y plane of another part.
