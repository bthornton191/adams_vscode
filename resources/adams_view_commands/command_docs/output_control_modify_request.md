...
|---|---|---|
| `request_name` | String | Specifies the name of the request to be modified. You may later identify a request by typing its name. |
...
| `variable_name` | String | Specifies one or more variables that represent the components associated with a request. This option is only available if the format of the results files is set to XML. |
