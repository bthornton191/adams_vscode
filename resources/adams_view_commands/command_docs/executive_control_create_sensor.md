...
|---|---|---|
| `sensor_name` | String | Specifies the name of the new sensor. You may use this name later to refer to this sensor. |
...
| `codgen` | ON/OFF | Specifies that Adams is to generate a new pivot sequence for matrix factorization when the event Adams is sensing has the specified relationship to VALUE. |
